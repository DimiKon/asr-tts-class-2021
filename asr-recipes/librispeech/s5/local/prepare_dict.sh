...
PYTHONIOENCODING=UTF-8 python3.8 local/vocab_concat.py $vocab 
...
general_lexicon=local/Greek400k.dictionary
...
if [ ! -f $lexicon_raw_nosil ]; then
  ...
  PYTHONIOENCODING=UTF-8 python3.8 local/create_lexicon.py $general_lexicon $vocab $lexicon_raw_nosil
  PYTHONIOENCODING=UTF-8 python3.8 local/write_dict.py $vocab $lexicon_raw_nosil
